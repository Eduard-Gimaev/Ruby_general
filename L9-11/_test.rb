...
@trains.each_with_index do |train, index|
  puts "#{index + 1}. #{train.number} - #{train.type} this train produced by #{train.show_manufacturer}"
end
puts 'Find'
Train.find('001-CC')
Train.find('003-PP')
...
@wagons.each_with_index do |wagon, index|
  puts "#{index + 1}) #{wagon.number}.#{wagon.type} wagon produced by #{wagon.show_manufacturer}"
end
